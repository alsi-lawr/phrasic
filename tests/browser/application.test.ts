...
} from "../../apps/web/src/browser/application.ts";
import type { BrowserConfigurationResponse } from "../../apps/web/src/browser/configuration-response.ts";
import type {
  PlaybackWorkerCommand,
  PlaybackWorkerEvent,
} from "../../apps/web/src/browser/worker/protocol.ts";
import { spotifyBrowserIntegration } from "../../apps/web/src/browser/integrations/spotify-browser-integration.ts";
