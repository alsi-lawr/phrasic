...
import { OverlaySetupDiagnostic } from "../../apps/web/src/components/overlay/OverlaySetupDiagnostic.tsx";
import type { OverlayDisplayDiagnostic } from "../../apps/web/src/components/overlay/overlay-geometry.ts";
