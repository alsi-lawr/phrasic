...
import { redeemPairingCapability } from "../../apps/web/src/browser/local/pairing.ts";
import { parseLocalHostOptions } from "../../apps/host/src/local/options.ts";
import { createPairingAuthority } from "../../apps/host/src/local/pairing.ts";
