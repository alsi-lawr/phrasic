...
import type { BrowserPlaybackApplicationSnapshot } from "../../apps/web/src/browser/application.ts";
import { parseSpotifyPlaybackPayload } from "../../apps/web/src/browser/providers/spotify-payload.ts";
import { spotifyOverlayPresentation } from "../../apps/web/src/browser/providers/spotify-presentation.ts";
import { OverlayMetadata } from "../../apps/web/src/components/overlay/OverlayMetadata.tsx";
import {
  overlayAnimationIdentityKey,
  overlayItemIdentityKey,
} from "../../apps/web/src/components/overlay/overlay-identities.ts";
import { overlayMotionDecisionForPreference } from "../../apps/web/src/components/overlay/overlay-motion.ts";
import { parseDisplayText } from "../../packages/domain/src/playback-values.ts";
import {
  createPlaybackSnapshot,
  createTrackItem,
  type TrackItem,
} from "../../packages/domain/src/playback-item.ts";
import { type PlaybackState } from "../../packages/domain/src/playback.ts";
import { type Result } from "../../packages/domain/src/result.ts";
import {
