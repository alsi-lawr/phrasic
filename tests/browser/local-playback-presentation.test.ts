...
import { LocalPlaybackOverlay } from "../../apps/web/src/components/local/LocalPlaybackOverlay.tsx";
import { localPlaybackView } from "../../apps/web/src/browser/local/presentation-view.ts";
import { localAnimationIdentityKey } from "../../apps/web/src/components/local/local-playback-identity.ts";
import { resolveOverlayGeometry } from "../../apps/web/src/components/overlay/overlay-geometry.ts";
...
} from "../../packages/domain/src/local-playback.ts";
