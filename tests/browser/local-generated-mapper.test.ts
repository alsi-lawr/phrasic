...
import { mapGeneratedSnapshot } from "../../apps/web/src/browser/local/generated-mapper.ts";
import { unavailableLocalLastSuccessfulSnapshot } from "../../packages/domain/src/local-playback.ts";
