import type { ItemConstructionError } from "../../../../../packages/domain/src/playback-item.ts";
import type { ValueValidationError } from "../../../../../packages/domain/src/playback-values.ts";
import {
  failed,
  succeeded,
  type Result,
} from "../../../../../packages/domain/src/result.ts";
import type {
